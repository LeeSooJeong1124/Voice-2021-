...
class CnnLSTM(nn.Module):
    def __init__(self, num_channels=3, channel_1=16, channel_2=8, hidden_size=16, num_layers=2, batch_size=20, num_classes=8):
        ...
        self.LSTM = nn.LSTM(21,self.hidden_size, self.num_layers, batch_first=True)
...
class CNN_A(nn.Module):
    def __init__(self, num_channels=3, channel_1=16, channel_2=32, num_classes=5):
...
def train(model, loader_train, loader_valid, tb_path, optimizer, epochs=1, print_every=50):
    ...
    for e in range(epochs):
        ...
        acc1 = check_accuracy(loader=loader_train, model=model, dataset='train')
        acc.append(acc1)
        
        acc_val1 = check_accuracy(loader=loader_valid, model=model, dataset='valid')
